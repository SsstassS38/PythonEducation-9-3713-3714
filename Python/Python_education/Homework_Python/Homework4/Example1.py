...
def RandomPolynom():                                      # Cловарь для степени первого многочлена
        dictionary = {}
...
def StringBeautiful(dictionary: dict):                    # Словарь пишем в строку для красивого оформления многочленов 
    my_str = ' '
...
def ReplacePolynom(data):                                   # Строку с примерами многочленов делаем в список удаляя лишние знаки
    for line in data:
        stroka = line
...
polynomialOne = OpenAndWriteFile(open(r'D:\Geek Brains\Python\Python_education\Homework_Python\Homework4\text1.txt', 'w'))
polynomialTwo = OpenAndWriteFile(open(r'D:\Geek Brains\Python\Python_education\Homework_Python\Homework4\text2.txt', 'w'))
# Печать словарей которые мы записали в файлы
print(f'Словарь первого многочлена \n{polynomialOne}\n')
print(f'Словарь второго многочлена \n{polynomialTwo}\n')
my_list = ReplacePolynom(open(r'D:\Geek Brains\Python\Python_education\Homework_Python\Homework4\text1.txt', 'r'))
my_listTwo = ReplacePolynom(open(r'D:\Geek Brains\Python\Python_education\Homework_Python\Homework4\text2.txt', 'r'))
...
data = open(r'D:\Geek Brains\Python\Python_education\Homework_Python\Homework4\text3.txt', 'w')
